...
|Usage Note:|If the data catalog also contains information on data sevices, this class can be used in conjunction with [dcat:DataService](https://www.w3.org/TR/vocab-dcat-2/#Class:Data_Service).|
  ...
  |**Property**|<span style="font-weight:normal">pmt:resourceProvider</span>|
  |---|---|
  ...
  #### Property: Domain
  |**Property:**|<span style="font-weight:normal">pmt:domain</span>|
  |---|---|
  ...
  |**Property:**|<span style="font-weight:normal">pmt:hasNewVersion</span>|
  |---|---|
  ...
  |**Property:**|<span style="font-weight:normal">pmt:hasOldVersion</span>|
  |---|---|
  ...
  #### Property: Consumes
  |**Property:**|<span style="font-weight:normal">pmt:consumes</span>|
  |---|---|
...
### Class: Domain
|**Class:**|<span style="font-weight:normal">[pmt:Domain]()</span>|
|---|---|
...
|Usage Note:|If use cases generate new data, they can, over time also lead to new data products.|
  ...
  |**Property:**|<span style="font-weight:normal">[pmt:plannedEndDate]()</span>|
  |---|---|
...
|**Class:**|<span style="font-weight:normal">[pmt:Dataset]()</span>|
|---|---|
...
### Class: Output Port
|**Class:**|<span style="font-weight:normal">[pmt:OutputPort]()</span>|
|---|---|
...
|Usage Note:|Output ports represent the various ways in which data products expose their data. For example, data can be made available through a download link, a SQL-based API or a kafka-stream.|
  ...
  #### Property: Distribution
  |**Property:**|<span style="font-weight:normal">[dcat:exposesDistribution](http://www.w3.org/ns/dcat#distribution)</span>|
  |---|---|
  ...
  |**Property**|<span style="font-weight:normal">[pmt:consumeInstructions]()</span>|
  |---|---|
  |Definition|Human-readable instructions on how to consume data through this output port.|
  |Usage note:|Consume instructions are the informal equivalent of the [pmt:dataContract](#property:-data-contract), which captures the formal promises and expectations of this output port.|
  
  #### Property: Data Contract
  |**Property**|<span style="font-weight:normal">[pmt:dataContract]()</span>|
  |---|---|
  |Definition|The data contract associated with this output port.|

### Class: Data Contract
|**Class:**|<span style="font-weight:normal">[pmt:DataContract]()</span>|
|---|---|

...
- [ProMoTe](#promote)
  ...
  - [Specification](#specification)
    - [Class: Resource](#class-resource)
      ...
      - [Property: Domain](#resource-property-description)
      ...
      - [Property: Catalog Record](#property-catalog-record)
    ...
    - [Class: Data Product](#class-data-product)
      ...
      - [Property: Enforcement Logic](#data-product-property-enforcement-logic)
    ...
    - [Class: Output Port](#class-output-port)
      ...
      - [Property: Exposes Data Product](#property-exposes-data-product)
    ...
    - [Class: Data Contract](#class-data-contract)
      ...
      - [Property: Applies to Port](#property-applies-to-port)
    - [Class: Input Port](#class-input-port)
      - [Property: Description](#input-port-property-description)
      - [Property: Corresponding Data Product](#input-port-corresponding-data-product)
      - [Property: Consumes](#input-port-property-consumes)
      - [Property: Source System](#input-port-propert-source-system)
    - [Class: Control Port](#class-control-port)
      - [Property: Description](#control-port-property-description)
      - [Property: Corresponding Data Product](#control-port-property-corresponding-data-product)
      - [Property: Policy](#control-port-property-policy)
...
## Specification
![UML](https://raw.githubusercontent.com/Stefan-Driessen/ProMoTe/main/ProMoTe_v5.4.png)
...
The following property is shared with the [pmt:OutputPort](#class-output-port) class: [data contract](#output-port-property-data-contract).
